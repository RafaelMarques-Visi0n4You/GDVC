...
const getAguardarVisitas = async (req, res) => {
    const empresaID = req.body.empresa_id;
    try {
        const visitas = await Visita.findAll({
            where: {
                estado_servico: 'a aguardar'
            },
            order: [
                ['data_visita', 'DESC'],
                ['hora_visita_inicio', 'ASC']
...
const getHistoricoVisitas = async (req, res) => {
    ...
    try {
        ...
        const visitas2 = await Visita.findAll({
            where: {
        ...
        const visitasComServicos = visitas.concat(visitas2);
...
const getVisitasEstadoPendentes = async (req, res) => {
    const empresaID = req.body.empresa_id;
    try {
        const visitas = await Visita.findAll({
            where: {
...
const getAgendadasVisitas = async (req, res) => {
    const empresaID = req.body.empresa_id;
    try {
        const visitas = await Visita.findAll({
            where: {
